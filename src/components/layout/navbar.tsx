...
function SearchButton() {
  ...
  return (
    <>
      <div
        className="fixed inset-0 z-60 bg-background/70 backdrop-blur-sm animate-scale-in"
        aria-hidden="true"
      />
      <div className="fixed inset-0 z-60 flex items-start justify-center pt-24">
        <div
          ref={panelRef}
          className="w-full max-w-lg overflow-hidden rounded-2xl border border-border bg-card shadow-2xl paper-card"
        >
