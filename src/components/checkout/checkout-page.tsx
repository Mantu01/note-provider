    ...
    <div className="mx-auto max-w-xl px-4 py-16">
      <div className="space-y-4 rounded-2xl border border-border bg-card p-6 text-center sm:p-8">
        ...
        <div>
          ...
          <h1 className="mt-2 text-lg font-bold tracking-tight sm:text-xl">This note is free to download</h1>
  ...
  return (
    <div className="mx-auto max-w-5xl px-3 py-5 sm:px-4 sm:py-7">
      <Link
        ...
        className="mb-3.5 inline-flex min-h-9 items-center gap-1.5 text-xs text-muted-foreground transition-colors hover:text-foreground"
      >
          ...
          <div className="rounded-xl border border-border bg-card p-4 shadow-sm sm:p-5">
            <div className="space-y-1.5">
              ...
              <Input
                ...
                className="h-10 rounded-lg sm:h-11"
              />
            ...
            <Button
              type="submit"
              size="lg"
              className="mt-4 h-11 w-full rounded-lg text-sm font-semibold bg-accent text-accent-foreground shadow-lg"
