  ...
  return (
    <article className="group relative overflow-hidden rounded-xl border border-border bg-card transition-shadow hover:shadow-md">
      ...
      >
        ...
        <span className="absolute right-2 bottom-2 inline-flex items-center gap-1.5 rounded-full bg-card/95 px-2 py-0.5 text-[10px] font-semibold text-foreground shadow-sm">
      ...
      <div className="space-y-2 p-3.5">
        ...
        <Link
          href={`/groups/${group.slug}`}
          className="block font-heading text-sm font-semibold leading-snug text-foreground transition-colors group-hover:text-primary"
        >
          {group.name}
        </Link>
