...
const noteSchema = new Schema(
  {
    ...
    fullFilePublicId: { type: String, default: null },
    fullFileBytes: { type: Number, default: 0 },
    pdfSource: { type: String, enum: ["upload", "drive"], default: "upload", index: true },
    drivePdfUrl: { type: String, default: null },
