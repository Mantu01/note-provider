...
export default function NotFound() {
  return (
    <main className="relative grid min-h-screen place-items-center px-4 paper-bg">
      <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(ellipse_at_center,var(--primary),transparent_60%)] opacity-10" />
      <div className="relative z-10 flex max-w-sm flex-col items-center gap-5 rounded-2xl border border-border/60 bg-card p-8 text-center shadow-sm">
        ...
        <Button render={<Link href="/" />} className="rounded-full bg-accent text-accent-foreground shadow-lg">
          Back home
        </Button>
      </div>
    </main>
