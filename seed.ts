...
async function main() {
  ...
  const notesData = [
    { ...{ title: "JavaScript Fundamentals", slug: "javascript-fundamentals", description: "A structured guide to JavaScript syntax, functions, objects, arrays, and asynchronous programming.", categoryId: webCategory.id, level: "basics" as const, visibility: "public" as const, pricingType: "free" as const, price: 0, compareAtPrice: null, fullFileUrl, previewFileUrl: fullFileUrl, coverImageUrl, pageCount: 42, tags: ["javascript", "web-development", "basics"], isFeatured: true, downloadCount: 184, purchaseCount: 0, revenuePaise: 0, createdBy: headAdmin.id, updatedBy: headAdmin.id, createdAt: new Date("2026-02-01T09:00:00.000Z"), updatedAt: new Date("2026-02-05T09:00:00.000Z") } },
    { ...{ title: "React Patterns in Practice", slug: "react-patterns-in-practice", description: "Reusable React patterns covering component composition, state management, effects, and performance.", categoryId: webCategory.id, level: "intermediate" as const, visibility: "public" as const, pricingType: "paid" as const, price: 29900, compareAtPrice: 49900, fullFileUrl, previewFileUrl: fullFileUrl, coverImageUrl, pageCount: 86, tags: ["react", "frontend", "components", "performance"], isFeatured: true, downloadCount: 96, purchaseCount: 32, revenuePaise: 956800, createdBy: contentAdmin.id, updatedBy: contentAdmin.id, createdAt: new Date("2026-02-04T09:00:00.000Z"), updatedAt: new Date("2026-02-11T09:00:00.000Z") } },
    { ...{ title: "Data Structures and Algorithms", slug: "data-structures-and-algorithms", description: "Interview-ready explanations and problem-solving patterns for essential data structures and algorithms.", categoryId: computerCategory.id, level: "advance" as const, visibility: "public" as const, pricingType: "paid" as const, price: 59900, compareAtPrice: 79900, fullFileUrl, previewFileUrl: fullFileUrl, coverImageUrl, pageCount: 156, tags: ["dsa", "algorithms", "interviews", "problem-solving"], isFeatured: false, downloadCount: 71, purchaseCount: 18, revenuePaise: 1078200, createdBy: headAdmin.id, updatedBy: contentAdmin.id, createdAt: new Date("2026-02-08T09:00:00.000Z"), updatedAt: new Date("2026-02-15T09:00:00.000Z") } },
    { ...{ title: "System Design Essentials", slug: "system-design-essentials", description: "A practical introduction to scalable services, APIs, databases, caching, queues, and reliability.", categoryId: interviewCategory.id, level: "advance" as const, visibility: "private" as const, pricingType: "paid" as const, price: 89900, compareAtPrice: null, fullFileUrl, previewFileUrl: fullFileUrl, coverImageUrl, pageCount: 204, tags: ["system-design", "backend", "scalability"], isFeatured: false, downloadCount: 12, purchaseCount: 4, revenuePaise: 359600, createdBy: headAdmin.id, updatedBy: headAdmin.id, createdAt: new Date("2026-02-12T09:00:00.000Z"), updatedAt: new Date("2026-02-12T09:00:00.000Z") } },
    { ...{ title: "Resume Writing for Developers", slug: "resume-writing-for-developers", description: "Actionable guidance for writing a clear, measurable, and recruiter-friendly developer resume.", categoryId: interviewCategory.id, level: "basics" as const, visibility: "public" as const, pricingType: "free" as const, price: 0, compareAtPrice: 14900, fullFileUrl, previewFileUrl: fullFileUrl, coverImageUrl, pageCount: 28, tags: ["resume", "career", "interviews"], isFeatured: false, downloadCount: 211, purchaseCount: 0, revenuePaise: 0, createdBy: contentAdmin.id, updatedBy: contentAdmin.id, createdAt: new Date("2026-02-16T09:00:00.000Z"), updatedAt: new Date("2026-02-16T09:00:00.000Z") } },
    { ...{ title: "Database Design and SQL", slug: "database-design-and-sql", description: "Clear notes on relational modeling, normalization, SQL queries, indexes, and transactions.", categoryId: computerCategory.id, level: "intermediate" as const, visibility: "public" as const, pricingType: "paid" as const, price: 39900, compareAtPrice: 59900, fullFileUrl, previewFileUrl: fullFileUrl, coverImageUrl, pageCount: 98, tags: ["dbms", "sql", "databases", "backend"], isFeatured: true, downloadCount: 54, purchaseCount: 11, revenuePaise: 438900, createdBy: headAdmin.id, updatedBy: contentAdmin.id, createdAt: new Date("2026-02-20T09:00:00.000Z"), updatedAt: new Date("2026-02-25T09:00:00.000Z") } },
  ];
  ...
  const ordersData = [
    { orderNumber: "NP-2026-0001", itemType: "note" as const, noteId: notes[1].id, groupId: null, itemSnapshot: makeSnapshot(notes[1].title, notes[1].slug, notes[1].price, [notes[1].id]), amount: 29900, buyer: { fullName: "Priya Mehta", consentAccepted: true, ipAddress: "203.0.113.11", userAgent: "Mozilla/5.0 Chrome/136" }, razorpayOrderId: "order_seed_paid_0001", razorpayPaymentId: "pay_seed_paid_0001", razorpaySignature: "seed_signature_paid_0001", paymentMethod: "upi", paymentStatus: "paid" as const, failureReason: null, paidAt: new Date("2026-04-02T10:05:00.000Z"), createdAt: new Date("2026-04-02T10:04:00.000Z"), updatedAt: new Date("2026-04-02T10:06:00.000Z") },
    { orderNumber: "NP-2026-0002", itemType: "group" as const, noteId: null, groupId: groups[0].id, itemSnapshot: makeSnapshot(groups[0].name, groups[0].slug, groups[0].price, [notes[0].id, notes[1].id]), amount: 49900, buyer: { fullName: "Rohan Verma", consentAccepted: true, ipAddress: null, userAgent: "Mozilla/5.0 Safari/18" }, razorpayOrderId: "order_seed_created_0002", razorpayPaymentId: null, razorpaySignature: null, paymentMethod: null, paymentStatus: "created" as const, failureReason: null, paidAt: null, createdAt: new Date("2026-04-04T11:00:00.000Z"), updatedAt: new Date("2026-04-04T11:00:00.000Z") },
    { orderNumber: "NP-2026-0003", itemType: "note" as const, noteId: notes[2].id, groupId: null, itemSnapshot: makeSnapshot(notes[2].title, notes[2].slug, notes[2].price, [notes[2].id]), amount: 59900, buyer: { fullName: "Neha Iyer", consentAccepted: true, ipAddress: "198.51.100.42", userAgent: null }, razorpayOrderId: "order_seed_failed_0003", razorpayPaymentId: null, razorpaySignature: null, paymentMethod: "card", paymentStatus: "failed" as const, failureReason: "Payment declined by issuing bank.", paidAt: null, createdAt: new Date("2026-04-06T14:00:00.000Z"), updatedAt: new Date("2026-04-06T14:15:00.000Z") },
    { orderNumber: "NP-2026-0004", itemType: "group" as const, noteId: null, groupId: groups[1].id, itemSnapshot: makeSnapshot(groups[1].name, groups[1].slug, groups[1].price, [notes[2].id, notes[3].id, notes[4].id]), amount: 129900, buyer: { fullName: "Kabir Singh", consentAccepted: false, ipAddress: "192.0.2.88", userAgent: "Mozilla/5.0 Firefox/138" }, razorpayOrderId: "order_seed_pending_0004", razorpayPaymentId: null, razorpaySignature: null, paymentMethod: "netbanking", paymentStatus: "created" as const, failureReason: null, paidAt: null, createdAt: new Date("2026-04-08T16:00:00.000Z"), updatedAt: new Date("2026-04-08T16:00:00.000Z") },
    { orderNumber: "NP-2026-0005", itemType: "note" as const, noteId: notes[5].id, groupId: null, itemSnapshot: makeSnapshot(notes[5].title, notes[5].slug, notes[5].price, [notes[5].id]), amount: 39900, buyer: { fullName: "Ananya Rao", consentAccepted: true, ipAddress: "203.0.113.77", userAgent: "Mozilla/5.0 Edge/136" }, razorpayOrderId: "order_seed_cancelled_0005", razorpayPaymentId: "pay_seed_cancelled_0005", razorpaySignature: "seed_signature_cancelled_0005", paymentMethod: "wallet", paymentStatus: "paid" as const, failureReason: null, paidAt: new Date("2026-04-10T09:00:00.000Z"), createdAt: new Date("2026-04-10T08:59:00.000Z"), updatedAt: new Date("2026-04-10T09:30:00.000Z") },
  ];
