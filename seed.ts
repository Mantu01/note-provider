...
async function seed() {
  ...
  const itemSnapshot = (title: string, slug: string, price: number, noteIds: mongoose.Schema.Types.ObjectId[], cover = coverImageUrl) => ({ title, slug, price, noteIds, coverImageUrl: cover });
  await Order.insertMany([
    {
      orderNumber: "NP-2026-0001", itemType: "note", note: notes[1]._id, group: null, itemSnapshot: itemSnapshot(notes[1].title, notes[1].slug, notes[1].price, [notes[1]._id]), amount: 29900, currency: "INR", buyer: { fullName: "Priya Mehta", consentAccepted: true, ipAddress: "203.0.113.11", userAgent: "Mozilla/5.0 Chrome/136" }, razorpayOrderId: "order_seed_paid_0001", razorpayPaymentId: "pay_seed_paid_0001", razorpaySignature: "seed_signature_paid_0001", paymentMethod: "upi", paymentStatus: "paid", fulfillmentStatus: "completed", failureReason: null, adminNote: "Delivered automatically after payment verification.", paidAt: new Date("2026-04-02T10:05:00.000Z"), completedAt: new Date("2026-04-02T10:06:00.000Z"), completedBy: headAdmin._id, createdAt: new Date("2026-04-02T10:04:00.000Z"), updatedAt: new Date("2026-04-02T10:06:00.000Z"),
    },
    {
      orderNumber: "NP-2026-0002", itemType: "group", note: null, group: frontendGroup._id, itemSnapshot: itemSnapshot(frontendGroup.name, frontendGroup.slug, frontendGroup.price, frontendGroup.notes), amount: 49900, currency: "INR", buyer: { fullName: "Rohan Verma", consentAccepted: true, ipAddress: null, userAgent: "Mozilla/5.0 Safari/18" }, razorpayOrderId: "order_seed_created_0002", razorpayPaymentId: null, razorpaySignature: null, paymentMethod: null, paymentStatus: "created", fulfillmentStatus: "pending", failureReason: null, adminNote: null, paidAt: null, completedAt: null, completedBy: null, createdAt: new Date("2026-04-04T11:00:00.000Z"), updatedAt: new Date("2026-04-04T11:00:00.000Z"),
    },
    {
      orderNumber: "NP-2026-0003", itemType: "note", note: notes[2]._id, group: null, itemSnapshot: itemSnapshot(notes[2].title, notes[2].slug, notes[2].price, [notes[2]._id]), amount: 59900, currency: "INR", buyer: { fullName: "Neha Iyer", consentAccepted: true, ipAddress: "198.51.100.42", userAgent: null }, razorpayOrderId: "order_seed_failed_0003", razorpayPaymentId: null, razorpaySignature: null, paymentMethod: "card", paymentStatus: "failed", fulfillmentStatus: "cancelled", failureReason: "Payment declined by issuing bank.", adminNote: "Customer may retry checkout.", paidAt: null, completedAt: null, completedBy: null, createdAt: new Date("2026-04-06T14:00:00.000Z"), updatedAt: new Date("2026-04-06T14:15:00.000Z"),
    },
    {
      orderNumber: "NP-2026-0004", itemType: "group", note: null, group: interviewGroup._id, itemSnapshot: itemSnapshot(interviewGroup.name, interviewGroup.slug, interviewGroup.price, interviewGroup.notes), amount: 129900, currency: "INR", buyer: { fullName: "Kabir Singh", consentAccepted: false, ipAddress: "192.0.2.88", userAgent: "Mozilla/5.0 Firefox/138" }, razorpayOrderId: "order_seed_pending_0004", razorpayPaymentId: null, razorpaySignature: null, paymentMethod: "netbanking", paymentStatus: "created", fulfillmentStatus: "pending", failureReason: null, adminNote: "Awaiting payment confirmation.", paidAt: null, completedAt: null, completedBy: null, createdAt: new Date("2026-04-08T16:00:00.000Z"), updatedAt: new Date("2026-04-08T16:00:00.000Z"),
    },
    {
      orderNumber: "NP-2026-0005", itemType: "note", note: notes[5]._id, group: null, itemSnapshot: itemSnapshot(notes[5].title, notes[5].slug, notes[5].price, [notes[5]._id]), amount: 39900, currency: "INR", buyer: { fullName: "Ananya Rao", consentAccepted: true, ipAddress: "203.0.113.77", userAgent: "Mozilla/5.0 Edge/136" }, razorpayOrderId: "order_seed_cancelled_0005", razorpayPaymentId: "pay_seed_cancelled_0005", razorpaySignature: "seed_signature_cancelled_0005", paymentMethod: "wallet", paymentStatus: "paid", fulfillmentStatus: "cancelled", failureReason: null, adminNote: "Cancelled at customer request before delivery.", paidAt: new Date("2026-04-10T09:00:00.000Z"), completedAt: null, completedBy: null, createdAt: new Date("2026-04-10T08:59:00.000Z"), updatedAt: new Date("2026-04-10T09:30:00.000Z"),
    },
  ]);
